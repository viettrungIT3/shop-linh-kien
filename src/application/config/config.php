...
|
*/
$config['log_threshold'] = $_ENV['DEBUG_LEVEL'] ?? 0;
...
$config['sess_cookie_name'] = $_ENV['COOKIE_NAME'];
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = $_ENV['SESSION_PATH'];
...
// allowed origins recording a list of ips or domain 
// as allowed refererers
