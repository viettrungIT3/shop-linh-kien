			...
			<div class="screen-1">
				...
				<div class="email">
					...
					<div class="sec-2">
						...
						<input type="email" name="input_user_login" placeholder="Please enter your email">
					</div>
				</div>
				<div class="password">
					...
					<div class="sec-2">
						...
						<input class="pas" type="password" name="input_user_password" placeholder="Please enter your password">
				...
				<div class="footer"><span><a href="/forgot-password">Forgot Password?</a></span></div>
			</div>
