            ...
            <div class="col-md-4">
                ...
                <div class="single-sidebar">
                    ...
                    <div class="thubmnail-recent">
                        <img src="<?php echo (get_media_uri('product-thumb-1.jpg')); ?>')); ?>" alt="">
                        ...
                        <div class="col-sm-6">
                            <div class="product-images">
                                ...
                                <div class="product-gallery">
                                    <img src="<?php echo (get_media_uri('product-thumb-1.jpg')); ?>" alt="">
                                    <img src="<?php echo (get_media_uri('product-thumb-2.jpg')); ?>" alt="">
                                    <img src="<?php echo (get_media_uri('product-thumb-3.jpg')); ?>" alt="">
                                    <img src="<?php echo (get_media_uri('product-thumb-4.jpg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
