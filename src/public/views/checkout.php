...
<link href="<?= get_assets_uri("css/checkout.css") ?>" rel="stylesheet" type="text/css" id="app-stylesheet">
...
<div class="container order-container">
    ...
    <div class="d-flex">
        ...
        <div class="Yorder">
            ...
            <div>
                <input id="rad2" type="radio" name="dbt" value="cd">
                <label for="rad2" style="display: inline-block;">Cash on Delivery</label>
            </div>
            <div>
                <input id="rad3" type="radio" name="dbt" value="cd">
                <label for="rad3" style="display: inline-block;">
                    Paypal <img src="https://www.logolynx.com/images/logolynx/c3/c36093ca9fb6c250f74d319550acac4d.jpeg" alt="" width="75">
