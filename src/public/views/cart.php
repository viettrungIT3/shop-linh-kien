              ...
              <div class="col-md-4">
                  ...
                  <div class="single-sidebar">
                      ...
                      <div class="thubmnail-recent">
                          <img src="<?php echo (get_media_uri('product-thumb-1.jpg')); ?>" class="recent-thumb"  alt="">
                                  ...
                                  <tbody>
                                      <tr class="cart_item">
                                          ...
                                          <td class="product-thumbnail">
                                              <a href="single-product"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo (get_media_uri('img/product-thumb-2.jpg')); ?>" alt=""></a>
                                          </td>
                                  ...
                                  <ul class="products">
                                      <li class="product">
                                          <a href="single-product">
                                              <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="<?php echo (get_media_uri('img/product-2.jpg')); ?>" alt="">
                                      ...
                                      <li class="product">
                                          <a href="single-product">
                                              <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="<?php echo (get_media_uri('img/product-4.jpg')); ?>" alt="">
                                              <h3>Ship Your Idea</h3>
                                              <span class="price"><span class="amount">£20.00</span></span>
                                          </a>
