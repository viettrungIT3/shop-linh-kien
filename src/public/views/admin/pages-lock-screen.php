...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Lock Screen | Simple - Responsive Bootstrap 4 Admin Dashboard</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center mb-4 mt-3">
                                    ...
                                    <div class="mt-4 pt-1">
                                        <img src="public\theme\images\admin\users\avatar-4.jpg" class="rounded-circle img-thumbnail" alt="thumbnail" style="height:88px;">
                                    </div>
                                    <p class="text-muted mb-0 font-13 mt-3">Enter your password to access the admin. </p>
                                </div>
