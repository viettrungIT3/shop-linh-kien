...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Maps | Simple - Responsive Bootstrap 4 Admin Dashboard</title>
...
<div class="left-side-menu">
    ...
    <!-- Left Sidebar End -->
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-3">Google Maps</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div>
                                    <h5 class="font-14 mb-3">Markers</h5>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mt-4 mt-lg-0">
                                    <h5 class="font-14 mb-3">Overlays</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mt-4">
                                    <h5 class="font-14 mb-3">Street View Panoramas</h5>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mt-4">
                                    <h5 class="font-14 mb-3">Map Types</h5>
                        ...
                        <div class="row mt-5">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-3">Vector Maps</h4>

                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div>
                                                <h5 class="font-14 mb-3">World Map</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mt-5">
                                                <h5 class="font-14 mb-3">USA Map</h5>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mt-5">
                                                <h5 class="font-14 mb-3">India Map</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mt-5">
                                                ...
                                                <h5 class="font-14 mb-3">UK Map</h5>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mt-5">
                                                <h5 class="font-14 mb-3">Chicago Map</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mt-5">
                                                ...
                                                <h5 class="font-14 mb-3">Australia Map</h5>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mt-5">
                                                <h5 class="font-14 mb-3">Canada Map</h5>
        ...
        <!-- gmap js-->
        <script src="public\theme\libs\gmaps\gmaps.min.js"></script>

        <!-- Init js-->
        <script src="public\theme\js\pages\google-maps.init.js"></script>

        <!-- Plugins js-->
        <script src="public\theme\libs\jquery-vectormap\jquery-jvectormap-1.2.2.min.js"></script>
        <script src="public\theme\libs\jquery-vectormap\jquery-jvectormap-world-mill-en.js"></script>
        <script src="public\theme\libs\jquery-vectormap\jquery-jvectormap-us-merc-en.js"></script>
        <script src="public\theme\libs\jquery-vectormap\jquery-jvectormap-in-mill-en.js"></script>
        <script src="public\theme\libs\jquery-vectormap\jquery-jvectormap-au-mill-en.js"></script>
        <script src="public\theme\libs\jquery-vectormap\jquery-jvectormap-us-il-chicago-mill-en.js"></script>
        <script src="public\theme\libs\jquery-vectormap\jquery-jvectormap-uk-mill-en.js"></script>
        <script src="public\theme\libs\jquery-vectormap\jquery-jvectormap-ca-lcc-en.js"></script>

        <!-- Init js-->
        <script src="public\theme\js\pages\vector-maps.init.js"></script>
